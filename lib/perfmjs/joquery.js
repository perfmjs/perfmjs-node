...
perfmjs.plugin('joquery', function($$) {
    ...
    if (typeof module !== 'undefined' && module.exports) {
        exports = module.exports = perfmjs.joquery;
    }
    /*for Node.js end*/
});
/*
...
var sample = lib.joquery.newInstance(SamplesData).updateOrInsert({ID: 0, firstName: "Chris", lastName: "Pearson", BookIDs: [1001, 1002, 1003]}, function(item){return item.ID == 9;}, function(item){return item.ID > 15;});
alert(lib.json.toJSON(sample));
var sample2 = joquery.newInstance(SamplesData).where(function(item, index){return item.ID == 9;});
alert(lib.json.toJSON(sample2.toArray()));*/