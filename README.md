perfmjs-node
=======
perfmjs(high performance javascript framework) for Node.js  V1.1.1
...
发布
=======
先修改README.md和package.json的版本号，如从1.0.0升到1.1.1,然后在项目路径下运行如下命令

>npm unpublish perfmjs-node@1.1.0 (这一步不是必需的)

>npm publish --tag 1.1.1
